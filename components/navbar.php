                    ...
                    <?php if (isset($user) && ($user['role'] === 'SYSTEM' || $user['role'] === 'ADMIN')) : ?>
                        <div class="relative group">
                            ...
                            <div class="absolute left-0 mt-1 w-56 bg-white rounded-2xl shadow-xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top-left -translate-y-2 group-hover:translate-y-0 z-50 overflow-hidden">
                                <div class="py-2">
                                    <a href="./?page=manage-request-types" class="flex items-center gap-3 px-5 py-3 text-sm text-gray-600 hover:bg-indigo-50 hover:text-indigo-700 transition-colors">
                                        ...
                                        <span class="font-medium">ปัญหาการใช้งาน</span>
                                    </a>
                                    <a href="./?page=manage-issue-categories" class="flex items-center gap-3 px-5 py-3 text-sm text-gray-600 hover:bg-indigo-50 hover:text-indigo-700 transition-colors">
                                        <div class="w-8 h-8 rounded-full bg-purple-50 text-purple-600 flex items-center justify-center">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                                            </svg>
                                    ...
                                    <a href="./?page=manage-issue-symptoms" class="flex items-center gap-3 px-5 py-3 text-sm text-gray-600 hover:bg-indigo-50 hover:text-indigo-700 transition-colors">
                                        <div class="w-8 h-8 rounded-full bg-purple-50 text-purple-600 flex items-center justify-center">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                                            </svg>
                                        </div>
                                        <span class="font-medium">อาการปัญหา</span>
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="px-4 py-4 space-y-1">
            ...
            <?php if (isset($user) && ($user['role'] === 'SYSTEM' || $user['role'] === 'ADMIN')) : ?>
                <div class="mt-4 pt-4 border-t border-gray-100">
                    <p class="px-4 text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2">แอดมิน</p>
                    
                    <a href="./?page=manage-request-types" class="mobile-nav-link flex items-center gap-3 px-4 py-3.5 rounded-xl text-gray-600 hover:bg-indigo-50 hover:text-indigo-600 font-medium transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                        </svg>
                        <span>ปัญหาการใช้งาน</span>
                    </a>
                    <a href="./?page=manage-issue-categories" class="mobile-nav-link flex items-center gap-3 px-4 py-3.5 rounded-xl text-gray-600 hover:bg-indigo-50 hover:text-indigo-600 font-medium transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                        </svg>
                        <span>ประเภท</span>
                    </a>
                    <a href="./?page=manage-issue-symptoms" class="mobile-nav-link flex items-center gap-3 px-4 py-3.5 rounded-xl text-gray-600 hover:bg-indigo-50 hover:text-indigo-600 font-medium transition-colors">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                        </svg>
            ...
            <?php if (isset($user) && $user['role'] === 'SYSTEM') : ?>
                <div class="mt-4 pt-4 border-t border-gray-100">
                    <p class="px-4 text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2">จัดการระบบ</p>
