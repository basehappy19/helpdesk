            ...
            <div class="flex items-center gap-8">
                ...
                <div class="hidden lg:flex items-center gap-1">
                    ...
                    <?php if (isset($user) && $user['role'] === 'SYSTEM') : ?>
                        <a href="./?page=manage-users" class="nav-link px-4 py-2 rounded-full text-sm font-medium text-gray-600 hover:text-indigo-600 hover:bg-indigo-50 transition-all duration-200 flex items-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
