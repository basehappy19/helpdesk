...
global $pdo;
require_once __DIR__ . '/../controllers/ManageRequestTypesController.php';
...
<head>
    ...
    <title>จัดการประเภทคำขอ (Request Types) | HelpDesk</title>
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php foreach ($items as $item): ?>
                                <tr class="hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-slate-500 text-xs"><?php echo date('d/m/Y H:i', strtotime($item['created_at'])); ?></td>
                                    <td class="px-6 py-4 text-right space-x-2">
                                        ...
                                        <form action="" method="POST" class="inline-block" onsubmit="return confirm('ยืนยันการลบข้อมูลนี้? (หากมีหมวดหมู่ย่อยผูกอยู่จะไม่สามารถลบได้)');">
